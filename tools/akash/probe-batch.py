...
ENDPOINT = sys.argv[1] if len(sys.argv) > 1 else "http://n3hs7iau5h9blbip24pdquobtg.ingress.h100.siamaidol.com"
...
with open("probe-batch-results.json", "w") as f:
    json.dump({"endpoint": ENDPOINT, "layers": LAYERS, "pairs": len(PAIRS), "summary": summary}, f, indent=2)
print("Saved probe-batch-results.json")
