...
ENDPOINT = sys.argv[1] if len(sys.argv) > 1 else "http://j3h3as8dn194l2slmnkpes5pp8.ingress.h100.ams2.val.akash.pub"
LAYERS = [5, 15, 25, 35, 45]
...
with open("probe-batch-glm45air-results.json", "w") as f:
    json.dump({"endpoint": ENDPOINT, "model": "zai-org/GLM-4.5-Air", "layers": LAYERS, "pairs": len(PAIRS), "summary": summary}, f, indent=2)
print("Saved probe-batch-glm45air-results.json")
