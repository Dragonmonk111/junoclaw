...
**Style suffix (use at the end of every prompt):**
`2D hand-drawn illustration in the exact style of E.H. Shepard's Winnie-the-Pooh and Wind in the Willows drawings, classic English vintage countryside, pen and ink linework with delicate watercolour wash, Christopher Robin storybook aesthetic, muted pastoral palette of sage green sea-grey oatmeal honey-yellow and faded rust, loose expressive cross-hatching, soft unsaturated colour, Ashdown Forest and coastal Sussex atmosphere, aged cream paper texture, children's book plate composition, gentle natural light`

> **Shared cast of background characters** (feel free to place one or two in any scene, small, never centre-stage): a boy of about seven in a blue smock and wellington boots who is clearly Christopher Robin, a plump honey-coloured bear walking on two legs a pace behind him, occasionally a small pink piglet half-hiding behind a gatepost, and in the quieter scenes a stuffed grey donkey grazing alone. Wooden hand-painted signs nailed crookedly to tree trunks — spelled in uneven child's capitals — are welcome on any prompt as scene-labels.

**Prompt 1 — The Harbour at Dawn (Hero):**
`A small English fishing harbour at first light, stone sea wall curving into mist, a row of wooden pilings half-submerged being inspected by a small boy in a blue smock and wellington boots carrying a lantern and a willow rod, a plump honey-coloured bear in a red jumper walking one pace behind him peering at the pilings, fishing boats moored beside a cobbled quay, thatched cottages on the hill behind, a weather-vane in the shape of a cockerel catching the first sun, seagulls low over the water, chalk cliffs visible in the distance, a small hand-painted wooden sign nailed to a post reading "THE BOUNDES" in uneven child's capitals, 2D hand-drawn illustration in the exact style of E.H. Shepard's Winnie-the-Pooh and Wind in the Willows drawings, classic English vintage countryside, pen and ink linework with delicate watercolour wash, Christopher Robin storybook aesthetic, muted pastoral palette of sage green sea-grey oatmeal honey-yellow and faded rust, loose expressive cross-hatching, aged cream paper texture, children's book plate composition, gentle natural light --ar 16:9 --s 250 --v 6.1`

**Prompt 2 — The Four Cracks (Survey of the Land):**
`A wide map-like English countryside scene drawn as if it were an endpaper from a Winnie-the-Pooh book, showing four small vignettes stitched into one pastoral landscape with winding dotted paths between them — a dry-stone wall with one stone missing (a wooden arrow-sign reading "WONE STONE GONE"), a farmyard gate with a broken slat leaning open ("THE GATE THAT LETS PENNYES THROO"), a small orchard with two identical apples on a labelled wooden box ("TWO APELS ONE TREE"), and a fisherman's stall on a harbour quay with mixed coins spilling out ("STRANJE COYNES HEER"), a plump honey-coloured bear examining the missing stone with a magnifying glass, a small pink piglet peeking round the broken gate, sheep and hens scattered in the middle distance, a distant church spire and the sea just visible on the horizon, 2D hand-drawn illustration in the exact style of E.H. Shepard, classic English vintage countryside, pen and ink linework with watercolour wash, Christopher Robin storybook aesthetic, muted pastoral palette of sage green sea-grey oatmeal and faded rust, aged cream paper texture --ar 16:9 --s 250 --v 6.1`

**Prompt 3 — The Blacksmith's Forge (The Build Pipeline):**
`A village blacksmith's forge at the edge of a coastal farm in the Hundred Acre Wood tradition, open stone archway glowing warm orange from within, a weathered smith in a leather apron holding an iron bar over an anvil with a small hammer, sparks rising into a cool grey evening sky, a hand-painted wooden sign above the doorway reading "W·ASM SMITHY" in old-fashioned letters, a small boy in a blue smock and a honey-coloured bear watching from a safe distance with wide eyes, an old cart outside loaded with six identical small iron ingots each labelled with a tiny chalk tag, the sea visible between two hills in the background with a distant lighthouse, rosehips and foxgloves in the hedgerow, 2D hand-drawn illustration in the exact style of E.H. Shepard's Winnie-the-Pooh and Wind in the Willows, pen and ink linework with watercolour wash, Christopher Robin storybook aesthetic, muted pastoral palette with warm forge-orange accent against sage green and sea-grey, aged cream paper texture, children's book plate composition --ar 16:9 --s 250 --v 6.1`

**Prompt 4 — The Country Lanes (The Wiring Discovery):**
`A hand-drawn map of the Hundred Acre Wood reimagined on the English coast, seen from a slight aerial tilt — narrow country lanes and woodland paths weaving between hedgerows and dry-stone walls, six small hand-drawn buildings at different crossroads each with a wooden signboard ("REGISTRY", "LEDGER", "ESCROW", "COMPANY", "GRANT", "PAIR") connected by dotted trail lines, a rickety wooden plank bridge over a stream (the Poohsticks bridge) at the missing link between two of them where a signpost has only three arms instead of four, a small boy in a blue smock standing at the broken signpost holding a pencil and a folded paper map, a honey-coloured bear beside him looking up thoughtfully, oast houses with white cowls in the middle distance, sheep scattered in the fields, coastline with chalk cliffs on the far horizon, compass rose drawn in a top corner, 2D hand-drawn illustration in the exact style of E.H. Shepard's Winnie-the-Pooh endpaper map, pen and ink linework with watercolour wash, classic English vintage countryside, muted pastoral palette of sage green sea-grey and honey-ochre, aged cream paper texture --ar 16:9 --s 250 --v 6.1`

**Prompt 5 — The Builder and The Contrarian Walking (The Testnet Voyage):**
`Two walkers on a coastal footpath along a chalk cliff overlooking a calm English sea, the first a small cheerful boy in a blue carpenter's smock and wellington boots with a measuring stick over one shoulder and a satchel of tools (clearly Christopher Robin in spirit, walking with a plump honey-coloured bear at his heel who is sniffing a boundary stone) — the second figure a few paces behind, a melancholy grey donkey wearing a dark violet saddle-cloth carrying a willow rod across his back (unmistakably Eeyore in temperament), both small companions pausing to tap a boundary stone inscribed with faint tally marks F1 F2 F3, a shepherd with his sheepdog watching from a nearby field, seagulls wheeling overhead, a fishing fleet far out on the water, a red-brick lighthouse at the end of the headland, gorse and sea-pinks at the cliff edge, 2D hand-drawn illustration in the exact style of E.H. Shepard's Winnie-the-Pooh, pen and ink linework with watercolour wash, Christopher Robin storybook aesthetic, muted pastoral palette of sage green sea-grey faded violet and honey-yellow, gentle afternoon light, aged cream paper texture, children's book plate composition --ar 16:9 --s 250 --v 6.1`

**Prompt 6 — The Shepherd Counting Sheep (The Regression Tests):**
`An elderly shepherd in a tweed waistcoat and flat cap (drawn as if he were Owl from Winnie-the-Pooh given human form) sitting on a low dry-stone wall with a large leather-bound tally book open on his knee, counting a small flock of sheep as they walk one by one through a narrow gate, each sheep numbered with a faint chalk mark on its shoulder ("F1" "F2" "F3" "F4" and more), a sheepdog lying watchful at his feet, a small boy in a blue smock sitting cross-legged nearby pretending to keep his own tally on a scrap of paper, a honey-coloured bear asleep in the grass with a small pot marked "HUNNY" beside him, a coastal meadow of long grass with a single oak tree, the English Channel visible beyond the cliff edge with a sailing ketch on the water, foxgloves and cow parsley in the foreground, 2D hand-drawn illustration in the exact style of E.H. Shepard, classic English vintage countryside, pen and ink linework with watercolour wash, Christopher Robin storybook aesthetic, muted pastoral palette of sage green oatmeal faded rose and honey-yellow, aged cream paper texture, gentle morning light --ar 16:9 --s 250 --v 6.1`

**Prompt 7 — The Village at Dusk (Closing):**
`A small English coastal farming village in the Hundred Acre Wood tradition seen from a gentle rise at twilight, smoke rising from four stone-cottage chimneys, a church tower at the centre with a lit lantern, orchards and small fields divided by hedgerows running down to the sea cliffs, a harbour with a single fishing boat returning in the last light, a narrow path winding down from the foreground with a small procession completing the beating of the bounds — a boy in a blue smock at the head carrying a willow rod, a plump honey-coloured bear just behind him holding his own smaller rod, a pink piglet trotting after them with a very tiny rod, and a grey donkey ambling at the rear, a wooden signboard at a turn in the path reading "THE BOUNDS · BEATEN" in uneven child's capitals, sheep settling in a field for the night, the first evening star visible above the sea, warm lamplight in cottage windows, 2D hand-drawn illustration in the exact style of E.H. Shepard's Winnie-the-Pooh and Wind in the Willows, pen and ink linework with watercolour wash, Christopher Robin storybook aesthetic, muted pastoral palette of deep sage evening-blue oatmeal and warm lamp-yellow, aged cream paper texture, children's book plate composition, peaceful closing tone --ar 16:9 --s 250 --v 6.1`
