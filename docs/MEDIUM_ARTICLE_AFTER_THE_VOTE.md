# After the Vote, the Long Afternoon

## Twenty-eight days between a 91.71 % YES on Proposal #373 and a governance-ready BN254 precompile. A ledger of the quiet work.
...
## IV. The optional zk-sidecar and the MCP
...
- BN254 precompile — awaiting upstream PR, signaling vote, `MsgSoftwareUpgrade`, zk-verifier migration.
...
## VIII. Closing — the morning of the twenty-eighth day
