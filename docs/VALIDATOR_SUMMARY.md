...
- **DAO governed.** 13-member DAO with 51% quorum for normal proposals, 67% supermajority for code upgrades. Built on the same budding model as Juno's own fairdrop — distribute power, don't hoard it.
...
with 67% supermajority for code upgrades. No funds requested.
